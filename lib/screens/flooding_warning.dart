...
class WarningFloodingScreen extends StatefulWidget {
  const WarningFloodingScreen({super.key});
  @override
  State<WarningFloodingScreen> createState() => _WarningFloodingScreenState();
}

class _WarningFloodingScreenState extends State<WarningFloodingScreen> {
                          ...
                          children: [
                            ...
                            Column(
                              children: const [
                                ...
                                Text(
                                  AppString.likelyToFlood +
                                      AppString.thirtyDays,
                                  style: TextStyle(
                                      color: AppColor.cardColor,
                                      fontSize: 18,
                                      fontWeight: FontWeight.bold),
