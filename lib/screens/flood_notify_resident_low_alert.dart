...
class FloodNotifyResidentLowAlertScreen extends StatefulWidget {
  const FloodNotifyResidentLowAlertScreen({super.key});
  @override
  State<FloodNotifyResidentLowAlertScreen> createState() =>
      _FloodNotifyResidentLowAlertScreenState();
}

class _FloodNotifyResidentLowAlertScreenState
    extends State<FloodNotifyResidentLowAlertScreen> {
