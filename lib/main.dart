...
import 'package:fmas/screens/all_screens.dart';
import 'package:fmas/screens/welcome_screen.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      initialRoute: AppRoute.allScreensRoute,
      routes: {
        AppRoute.defaultRoute: (context) => const WelcomeScreen(),
